...
class Ui_RedmineTaskDialog(object):
    def setupUi(self, RedmineTaskDialog):
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.taskNubmer)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.redmineProject)
